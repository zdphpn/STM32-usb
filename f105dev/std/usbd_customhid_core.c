...
__ALIGN_BEGIN static uint8_t USBD_CUSTOM_HID_CfgDesc[USB_CUSTOM_HID_CONFIG_DESC_SIZ] __ALIGN_END =
{
    ...
    0x09, USB_CONFIGURATION_DESCRIPTOR_TYPE, USB_CUSTOM_HID_CONFIG_DESC_SIZ, 0x00, 0x01, 0x01, 0x00, 0x40, 0x00,
    0x09, USB_INTERFACE_DESCRIPTOR_TYPE, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x00,
    0x07, USB_ENDPOINT_DESCRIPTOR_TYPE, HID_IN_EP1, 0x02, HID_IN_PACKET1, 0x00, 0xff,
    0x07, USB_ENDPOINT_DESCRIPTOR_TYPE, HID_OUT_EP1, 0x02, HID_OUT_PACKET1, 0x00, 0xff
    //		0x07,USB_ENDPOINT_DESCRIPTOR_TYPE,HID_IN_EP2,0x02,HID_IN_PACKET2,0x00,0xff,
    //		0x07,USB_ENDPOINT_DESCRIPTOR_TYPE,HID_OUT_EP2,0x02,HID_OUT_PACKET2,0x00,0xff
} ;
...
{
    /* Close HID EPs */
    DCD_EP_Close (pdev, HID_IN_EP1);
    DCD_EP_Close (pdev, HID_IN_EP2);
    DCD_EP_Close (pdev, HID_OUT_EP1);
                                        ...
                                        uint16_t len)
{
    ...
    {
        DCD_EP_Tx (pdev, HID_IN_EP1, report, len);
    }
    return USBD_OK;
}
                                        ...
                                        uint8_t epnum)
{
    ...
    //  USBD_CUSTOM_HID_SendReport(pdev, Report_buf, HID_OUT_PACKET);
