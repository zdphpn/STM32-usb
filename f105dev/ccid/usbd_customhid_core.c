...
__ALIGN_BEGIN static uint8_t USBD_CUSTOM_HID_CfgDesc[USB_CUSTOM_HID_CONFIG_DESC_SIZ] __ALIGN_END =
{
    ...
    0x09, USB_CONFIGURATION_DESCRIPTOR_TYPE, USB_CUSTOM_HID_CONFIG_DESC_SIZ, 0x00, 0x01, 0x01, 0x00, 0xC0, 0x32,
    ...
    0x02,		   			//	01H-5.0V,02H-3.0V,03H-1.8V
    ...
    0x80, 0x00, 0x04, 0x00, //  默认使能ICC,不知道啥作用,但确实有点作用,哈哈
    ...
    HID_CTL_EP,   /* bEndpointAddress: (IN2) */
    ...
    0x07,   /* bLength: Endpoint Descriptor size */
    USB_ENDPOINT_DESCRIPTOR_TYPE,   /* bDescriptorType: Endpoint */
    HID_OUT_EP,   /* bEndpointAddress: (OUT3) */
    ...
    0x07,   /* bLength: Endpoint Descriptor size */
    USB_ENDPOINT_DESCRIPTOR_TYPE,   /* bDescriptorType: Endpoint */
    HID_IN_EP,   /* bEndpointAddress: (IN1) */
    0x02,   /* bmAttributes: Bulk */
...
/**
  ...
  * @retval status
  */
uint8_t USBD_CUSTOM_HID_SendReport2     (USB_OTG_CORE_HANDLE  *pdev,
        uint8_t *report,
        uint16_t len)
{
    if (pdev->dev.device_status == USB_OTG_CONFIGURED )
    {
        DCD_EP_Tx (pdev, HID_CTL_EP, report, len);
    }
    return USBD_OK;
}
