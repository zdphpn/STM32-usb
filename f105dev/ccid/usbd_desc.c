...
#define USBD_PRODUCT_HS_STRING        "Custome CCID in HS Mode"
#define USBD_PRODUCT_FS_STRING        "Custome CCID in FS Mode"
#define USBD_CONFIGURATION_HS_STRING  "CCID Config"
#define USBD_INTERFACE_HS_STRING      "CCID Interface"
#define USBD_CONFIGURATION_FS_STRING  "CCID Config"
#define USBD_INTERFACE_FS_STRING      "CCID Interface"
/**
  * @}
  */
